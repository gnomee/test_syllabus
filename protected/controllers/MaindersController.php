...
class MaindersController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Mainders']))
		{
			$model->attributes=$_POST['Mainders'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Mainders');
	...
	{
		$model=new Mainders('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Mainders']))
			$model->attributes=$_GET['Mainders'];
	 ...
	 * @return Mainders the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Mainders::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Mainders $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mainders-form')
		{
